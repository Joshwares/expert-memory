<?php
	...
	if (isset($_POST['change'])) {
		...
		$check = "SELECT * FROM admins WHERE admPassword = '$oPass' ";
		...
		if ($result->num_rows > 0) {
			if ($newPass != $conPass) {
				...
				$check2 = "SELECT * FROM admins WHERE admPassword = '$nPass' ";
				...
				if ($result2->num_rows > 0) {
					...
					$update = "UPDATE admins set admPassword = '$nPass' WHERE admId = '$iD'";

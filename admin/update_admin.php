		...
		<title>PPMS | admin Profile Updation</title>
			...
			<div class="container-fluid" style="">
				<div class="dash jumbotron" style="height: 100px; padding: 35px; margin-top: -4vh;">
					<p>ADMIN | ADMIN PROFILE UPDATE</p>
				</div>
			</div>
						...
						<form class="form-register" method="post">
							<fieldset>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="fullname" placeholder="Full Name" value="<?php echo $admName; ?>">
								</div>
								<div class="form-group form-actions">
									<label class="control-lable">Address</label>
									<input type="text" class="form-control" name="address" placeholder="Address" value="<?php echo $admAddress; ?>">
								</div>
								<div class="form-group form-actions">
									<label class="control-lable">State</label>
									<input type="text" class="form-control" name="state" placeholder="State" value="<?php echo $admState; ?>">
								</div>
								<div class="form-group form-actions">
									<label class="control-lable">City</label>
									<input type="text" class="form-control" name="city" placeholder="City" value="<?php echo $admCity; ?>">
								</div>
								<div class="form-group form-actions">
									<label class="control-lable">Gender</label>
									<input type="text" class="form-control" name="gender" placeholder="Gender" value="<?php echo $admGender; ?>">
								</div>
								<div class="form-group form-actions">
								...
								<div class="form-group form-actions">
									...
									<input type="tel" class="form-control" name="tel-number" placeholder="Mobile Number" value="<?php echo $admNumber; ?>">
									<br>
									<p>
										Back to profile?
										<a href="admin_info.php?admId=<?php echo $iD; ?>">
											View Profile
										</a>
									</p>
								</div>
								...
								<div class="form-actions">
									...
									<a href="delete_admin.php?admId=<?php echo $admId; ?>">
